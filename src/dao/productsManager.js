...
class productDBManager {
    ...
    async getAllProducts(params) {
        ...
        products.prevLink = products.hasPrevPage?`http://localhost:3031/products?page=${products.prevPage}` : null;
        products.nextLink = products.hasNextPage?`http://localhost:3031/products?page=${products.nextPage}` : null;
